...
import wallet from 'services/user/wallet'
...
export default  ( app ) => {
	...
	app.use( '/create-wallet', authorizer(), wallet )
	app.use( '/delete-wallet', authorizer(), wallet )
	app.use( '/wallets', authorizer(), wallet )
}
